...
st.markdown("*Easy* as inputting your Tradingview credentials, tick the checkbox if you have a premium account. A free account is limited to 5000 candles")
...
st.markdown("**1. Username and Password**")
st.markdown("Same as OHLC, without the premium setting")
...
st.markdown("If the indicator is not in the dropdown, you can use the 'custom' setting:")
...
st.markdown("Start counting from after the indicator's name, some trial and error may be required")
